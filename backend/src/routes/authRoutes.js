...
const { registerUser, loginUser, getMe } = require('../controllers/authController'); // <-- Importa de authController.js
...
router.get('/me', protect, getMe); // Usa la función 'getMe' del controlador
